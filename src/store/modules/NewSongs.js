export default {
    ...
    actions: {
      checkPause({ commit, getters, dispatch, rootGetters }, index) {
        ...
        if (rootGetters['fixedplay/nameSpacedComponent'] !== 'newSongs' && rootGetters['fixedplay/nameSpacedComponent'] !== '') {
        ...
        dispatch('fixedplay/updateNameSpacedComponent', 'newSongs', { root: true })
